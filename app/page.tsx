        ...
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
          <div className="relative order-2 lg:order-1">
            ...
            <div className="absolute -bottom-4 -right-4 hidden lg:flex bg-[#0A1931] border-2 border-white shadow-xl p-5 items-center gap-4">
              ...
              <div>
                <div className="text-[#C5A253] text-base lg:text-lg tracking-[0.20em] uppercase font-black">{settings.site_name || "SAFE GUARD FORCE"}</div>
                <div className="text-white/90 text-xs lg:text-sm font-normal tracking-wide mt-0.5">{settings.tagline || "Your Security. Our Priority."}</div>
                <div className="text-white/60 text-xs mt-1 font-normal">Disciplined • Verified • Presentable</div>
              </div>
            </div>
            {/* Mobile badge */}
            <div className="flex lg:hidden bg-[#0A1931] p-3.5 items-center gap-3 mt-0 border border-slate-200 border-t-0">
              ...
              <div>
                <div className="text-[#C5A253] text-xs sm:text-sm tracking-[0.18em] uppercase font-black">{settings.site_name || "SAFE GUARD FORCE"}</div>
                <div className="text-white/90 text-[11px] sm:text-xs font-normal tracking-wide mt-0.5">{settings.tagline || "Your Security. Our Priority."}</div>
                <div className="text-white/60 text-[10px] sm:text-[11px] mt-0.5 font-normal">Disciplined • Verified • Presentable</div>
              </div>
            </div>
          </div>
