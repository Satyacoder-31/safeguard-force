  ...
  const sidebar = (
    <div className="flex flex-col h-full bg-[#0A1931] text-white">
      <div className="flex items-center gap-3 px-5 h-16 border-b border-white/10 shrink-0">
        <img src="/images/safelogo.png" alt="Logo" className="w-9 h-9 object-contain" />
        <div className="leading-tight">
          <div className="font-black tracking-widest text-sm">SG ADMIN</div>
          <div className="text-[#C5A253] text-[9px] tracking-[0.22em] uppercase font-bold">Content Manager</div>
        </div>
      </div>
    ...
    <>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-50 flex">
          ...
          <aside className="relative w-[280px] max-w-[85vw] h-full shadow-2xl">{sidebar}</aside>
        </div>
      )}
    </>
  );
